...
export class GridRendererSystem extends TickSystem {
    ...
    private maskToBeamColor(mask: number): string {
        switch (mask) {
            case 1: return "#ff4b4b";       // red
            case 2: return "#4dff88";       // green
            case 3: return "#ffe45c";       // red + green -> yellow
            case 4: return "#4da3ff";       // blue
            case 5: return "#d56bff";       // purple
            case 6: return "#62f5ff";       // cyan
            case 7:                         // rgb -> white
            case 15: return "#ffffff";      // all channels -> white
            case 8: return "#ffe45c";       // yellow
            case 9: return "#ff8c3a";       // orange
            case 10: return "#b4ff3a";      // lime
            case 11: return "#ff8c3a";      // orange fallback
            case 12: return "#62f5ff";      // cyan fallback
            case 13: return "#d56bff";      // purple fallback
            case 14: return "#62f5ff";      // cyan fallback
